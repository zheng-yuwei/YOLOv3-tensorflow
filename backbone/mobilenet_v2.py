...
class MobileNetV2(BasicBackbone):
    ...
    def build(cls, input_x):
        ...
        net = cls._inverted_residual_module(net, filters=64, expand_ratio=6, strides=(1, 1))
        sub_stride_8_net = cls._inverted_residual_module(net, filters=64, expand_ratio=6, strides=(1, 1))

        net = cls._expand_depthwise_linear(sub_stride_8_net, filters=96, expand_ratio=6, strides=(2, 2))
        net = cls._inverted_residual_module(net, filters=96, expand_ratio=6, strides=(1, 1))
        sub_stride_16_net = cls._inverted_residual_module(net, filters=96, expand_ratio=6, strides=(1, 1))

        net = cls._expand_depthwise_linear(sub_stride_16_net, filters=160, expand_ratio=6, strides=(2, 2))
        ...
        sub_stride_32_net = cls.activation(net)
